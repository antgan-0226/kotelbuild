...
to [how-to-add-a-new-rule.md](https://github.com/antgan-0226/opentelemetry-go-auto-instrumentation/blob/main/docs/how-to-add-a-new-rule.md),
...
```go
import "github.com/antgan-0226/opentelemetry-go-auto-instrumentation/test/verifier"
